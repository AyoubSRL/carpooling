...
<td>
    <a href="<?= $this->e($base_path) ?>/passeggeri/<?= $this->e($p['id']) ?>">Visualizza</a>
    <a href="<?= $this->e($base_path) ?>/passeggeri/<?= $this->e($p['id']) ?>/edit">Modifica</a>
    <a href="<?= $this->e($base_path) ?>/passeggeri/<?= $this->e($p['id']) ?>/delete" onclick="return confirm('Sei sicuro?')">Elimina</a>
</td></tr>
<?php endforeach; ?>
<?php else: ?>
